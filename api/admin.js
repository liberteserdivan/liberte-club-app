...
const ADMIN_RESOURCE_LOADERS = {
  ...
  'qr-verify': () => import('./_lib/handlers/adminQrVerify.js').then((m) => m.handleAdminQrVerify),
  'member-lookup': () => import('./_lib/handlers/adminQrVerify.js').then((m) => m.handleAdminMemberLookup),
