#!/usr/bin/env node
/** BUG-021 indexlerini uygular — tek tek statement, secret yazmaz */
...
const script = readFileSync(join(root, 'scripts/sql/011_auth_indexes.sql'), 'utf8');
...
console.log(JSON.stringify({ ok: true, step: 'indexes_applied', count: statements.length }));
